...
% su
# PKG_PATH=http://teokurebsd.org/netbsd/packages/`uname -p`/6.1.5_2015Q1/All pkg_add -v rpm2pkg nspluginwrapper
 :
# exit
...
% sh mk-adobe-flash-plugin-packages.sh
 :
% su
# PKG_PATH=http://teokurebsd.org/netbsd/packages/`uname -p`/6.1.5_2015Q1/All pkg_add -v `uname -p`/adobe-flash-plugin
 :
# exit
% 
