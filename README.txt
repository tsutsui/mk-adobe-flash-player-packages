...
% su
# PKG_PATH=http://teokurebsd.org/netbsd/packages/`uname -p`/`uname -r`_2015Q2/All pkg_add -v rpm2pkg nspluginwrapper
 :
# exit
...
% sh mk-adobe-flash-plugin-packages.sh
 :
% su
# PKG_PATH=http://teokurebsd.org/netbsd/packages/`uname -p`/`uname -r`_2015Q2/All pkg_add -v `uname -p`/adobe-flash-plugin
 :
# exit
% 
